...
const Home: React.FC = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 text-white flex flex-col items-center justify-start overflow-hidden">
      {/* ===== BACKGROUND FLASHING GRADIENT ===== */}
      <div className="absolute inset-0 bg-gradient-to-r from-blue-900 via-slate-900 to-blue-900 animate-pulse opacity-20 -z-10"></div>
      ...
      <section className="text-center mt-16 px-6">
        ...
        <div className="mt-8 flex justify-center gap-6">
          ...
          <button className="px-6 py-3 bg-gray-200 text-gray-900 rounded-lg font-semibold hover:bg-gray-300 transition">
            View Pricing
          </button>
        </div>
      </section>
      ...
      {/* ================= STATS SECTION ================= */}
      <section className="mt-20 flex flex-col sm:flex-row gap-10 text-center text-gray-300">
        <div>
      ...
      {/* ================= CORE PROGRAMS ================= */}
      <section className="mt-28 px-6 max-w-5xl">
      ...
      {/* ================= TESTIMONIALS ================= */}
      <section className="mt-28 px-6 max-w-4xl text-center">
